...
final Color seedColor = const Color.fromARGB(255, 59, 147, 155);
...
class ThemeService {
  ...
  static Future<ThemeMode> getThemeMode() async {
    ...
    int themeMode = prefs.getInt(PrefsString.themeModeKey) ?? 0;
  ...
  static Future<void> saveThemeMode(ThemeMode themeMode) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setInt(PrefsString.themeModeKey, themeMode.index);
